...
@section('title', 'Edit Profile | Kapabel Indonesia')
@push('styles')
    <style>
        :root {
            --primary-navy: #0F172A;
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="fw-bold m-0" style="font-family: 'Raleway', sans-serif;">Account Settings</h3>
                    <a href="{{ route('dashboard') }}" class="btn btn-outline-secondary rounded-pill btn-sm px-3"><i
                ...
                <div class="card shadow-sm border-0 rounded-4 mb-4">
                    <div class="card-body p-4 p-md-5">
                        <h5 class="fw-bold mb-1" style="font-family: 'Raleway', sans-serif;">Profile Information</h5>
                        ...
                        <form method="post" action="{{ route('profile.update') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    class="form-control px-3 py-2 border-light-subtle bg-light @error('name') is-invalid @enderror"
                            ...
                            <button type="submit" class="btn btn-primary px-4 py-2 rounded-pill fw-medium">Save
                                Changes</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0 rounded-4 mb-4">
                    <div class="card-body p-4 p-md-5">
                        <h5 class="fw-bold mb-1" style="font-family: 'Raleway', sans-serif;">Update Password</h5>
                        ...
                        <form method="post" action="{{ route('password.update') }}">
                            ...
                            <div class="mb-3">
                                <label for="current_password" class="form-label fw-medium text-dark">Current
                                    Password</label>
                                <input type="password"
                                    class="form-control px-3 py-2 border-light-subtle bg-light @error('current_password', 'updatePassword') is-invalid @enderror"
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="password"
                                        class="form-control px-3 py-2 border-light-subtle bg-light @error('password', 'updatePassword') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <label for="password_confirmation" class="form-label fw-medium text-dark">Confirm
                                        Password</label>
                                    <input type="password" class="form-control px-3 py-2 border-light-subtle bg-light"
                                        id="password_confirmation" name="password_confirmation" required>
                                </div>
                            </div>

                            <button type="submit" class="btn btn-dark px-4 py-2 rounded-pill fw-medium">Update
                                Password</button>
                        </form>
                    </div>
                </div>
